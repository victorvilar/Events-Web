...
<head>
    ...
    <!-- GLOBAL STYLES -->
    <!-- GLOBAL STYLES -->
    <link rel="stylesheet" href="${request.contextPath}/assets/plugins/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" href="${request.contextPath}/assets/css/main.css" />
    <link rel="stylesheet" href="${request.contextPath}/assets/css/theme.css" />
    <link rel="stylesheet" href="${request.contextPath}/assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="${request.contextPath}/assets/plugins/Font-Awesome/css/font-awesome.css" />
    <!--END GLOBAL STYLES -->

    <!-- PAGE LEVEL STYLES -->
    <link href="${request.contextPath}/assets/css/layout2.css" rel="stylesheet" />
